...
public class Queen implements ChessPiece {
	...
	public Queen(int currentX, int currentY, int whichPlayer) {
	...
	public void findValidMoves(String[][] copyBoard) {
		...
		for(int x = (row - 1); x >= 0; x--) {
			...
			char c = copyBoard[x][yChange].charAt(0);
			
			if(c == '#' || c== ' ') {
				GameMove m1 = new GameMove(x, yChange);
				this.possibleMoves.add(m1);
				continue;
				...
				if(this.whichPlayer == 1) {
					...
					GameMove m2 = new GameMove(x, yChange);
					this.possibleMoves.add(m2);
					break;
				}
			}
				...
				if(this.whichPlayer == 2) {
					...
					GameMove m3 = new GameMove(x, yChange);
					this.possibleMoves.add(m3);
					break;
				}
			}
		...
		for(int x = (row + 1); x <= 7; x++) {
			...
			if(c == '#' || c == ' ') {
				GameMove m4 = new GameMove(x, yChange);
				this.possibleMoves.add(m4);
				continue;
			}
			else if(c == 'w') {
				if(this.whichPlayer == 1) {
					...
					GameMove m5 = new GameMove(x, yChange);
					this.possibleMoves.add(m5);
					break;
				}
			}
				...
				if(this.whichPlayer == 2) {
					...
					GameMove m6 = new GameMove(x, yChange);
					this.possibleMoves.add(m6);
					break;
				}
			}
		...
		for(int x = (row - 1); x >= 0; x--) {
			...
			if(c == '#' || c == ' ') {
				GameMove m7 = new GameMove(x, yChange);
				this.possibleMoves.add(m7);
				continue;
			}
			else if(c == 'w') {
				if(this.whichPlayer == 1) {
					...
					GameMove m8 = new GameMove(x, yChange);
					this.possibleMoves.add(m8);
					break;
				}
			}
				...
				if(this.whichPlayer == 2) {
					...
					GameMove m9 = new GameMove(x, yChange);
					this.possibleMoves.add(m9);
					break;
				}
			}
		...
		for(int x = (row + 1); x <= 7; x++) {
			...
			if(c == '#' || c == ' ') {
				GameMove m10 = new GameMove(x, yChange);
				this.possibleMoves.add(m10);
				continue;
			}
			else if(c == 'w') {
				if(this.whichPlayer == 1) {
					...
					GameMove m11 = new GameMove(x, yChange);
					this.possibleMoves.add(m11);
					break;
				}
			}
				...
				if(this.whichPlayer == 2) {
					...
					GameMove m12 = new GameMove(x, yChange);
					this.possibleMoves.add(m12);
					break;
				}
			}
